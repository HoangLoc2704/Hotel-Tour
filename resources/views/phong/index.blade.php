...
<div class="alert alert-info">
    Danh sách dưới đây hiển thị <strong>phòng</strong>, còn thông tin <strong>giá / sức chứa / ảnh</strong> đang lấy theo <strong>loại phòng</strong> đã gán.
</div>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('phong.index') }}" class="row g-3 js-ajax-search" data-ajax-container="phong-list">
            <div class="col-md-8">
                <input type="text" name="search" class="form-control" placeholder="Tìm theo tên/mã phòng hoặc loại phòng..." value="{{ $search }}">
            </div>
            <div class="col-md-2">
